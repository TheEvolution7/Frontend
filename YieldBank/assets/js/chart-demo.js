        ...
        $( function() {
            ...
            var MainStage = function() {
                ...
                function init() {
                    ...
                    var ambientLight = new THREE.AmbientLight(0xfcd462 );
                    scene.add(ambientLight);
    
                    var lights = [];
                    lights[0] = new THREE.DirectionalLight( 0xfcd462, 1 );
                    lights[0].position.set( 1, 0, 0 );
                    lights[1] = new THREE.DirectionalLight( 0xfcd462, 1 );
                    lights[1].position.set( 0.75, 1, 0.5 );
                    lights[2] = new THREE.DirectionalLight( 0xfcd462, 1 );
                ...
                function render() {
                    ...
                    if ( typeof particles != typeof undefined ) {
                        ...
                        if ( delta - previousTime > thickness ) {
                            ...
                            TweenMax.to( particle, Math.random()*1+1, {
                                            x:    particle2.x, 
                                            y:    particle2.y, 
                            ...
                            TweenMax.to( particle2, Math.random()*1+1, {
                                            x:    particle1.x, 
                                            y:    particle1.y, 
                                            ease: Power2.easeInOut
                                        });
