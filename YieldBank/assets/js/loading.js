...
const effects = [
    // Effect 1
    {
        options: {
            shapeColors: ['#fcd462'],
            imgTypes: ['element_1', 'element_2', 'element_5', 'element_6','element_9', 'element_10', 'element_11'],
        },
        hide: {
    ...
    // Effect 2
    {
        ...
        show: {
            ...
            shapesAnimationOpts: {
                ...
                opacity: [{value: 1, duration:1, delay: (t,i) => i*80}, {value:0,duration: 1000, easing: 'easeOutQuad',delay: 100}]
            }
        }
    },
    // Effect 3
        ...
        show: {
            ...
            shapesAnimationOpts: {
                ...
                opacity: [
                    ...
                    {value: 0, duration: 1000, easing: 'easeOutQuad', delay: 200}
                ]
            }
        }
    },
        ...
        hide: {
            shapesAnimationOpts: {
                ...
                opacity: [
                    ...
                    {value: 0, duration: 1000, delay: 100, easing: 'easeOutQuad'}
                ]
            }
        },
        show: {
            ...
            shapesAnimationOpts: {
                ...
                opacity: [
                    {value: 1, duration: 1, easing: 'linear'}, 
                    {value: 0, duration: 1000, delay: 150, easing: 'easeOutQuad'}
                ]
            }
        }
    },
