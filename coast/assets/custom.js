(function($) {
  ...
  // $('.mega-menu-full',this).hide()
  // $('.has-submenu').on('mouseenter', function(){
  // 	$('.mega-menu-full',this).addClass('active');
  //   $('.mega-menu-full',this).fadeIn()
  // })
  // $('.has-submenu').on('mouseleave', function(){
  //   $('.mega-menu-full',this).fadeOut()
  // })
  // $('.mega-menu-full',this).hide()
  // $('.has-submenu').mouseenter(function () {
  //     $('.mega-menu-full', this).fadeIn(300);
  //     $(this).addClass('active-menu')
  // });
  // $('.has-submenu').mouseleave(function () {
  //     $('.mega-menu-full', this).fadeOut(200);
