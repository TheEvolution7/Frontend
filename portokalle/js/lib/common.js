...
(function () {
    $('.field1__pass').each(function(){
        var view = $('.js-field-view',this);
        var $this = $(this);
        view.on('click', function () {
            var i = $('input', $this)
            if (i.prop("type") !== 'text') {
...
(function () {
    $('.add-more-specialty').each(function() {
        var $this = $('.input-more-group',this);
        var upload = $('.field1', this).length;
        
        
        $('.add-more-input a',this).on('click', function(e) {
          e.preventDefault();
          var recRow = '<div class="field1 js-field more-container"><div class="field1__label">Specialty/practice</div><div class="field1__wrap"><input class="field1__input js-field-input" type="text" name="specialty-'+ upload +'"><button class="del-button" onclick="delRow(this)" type="button"><svg class="icon icon-trash"><use xlink:href="img/sprite.svg#icon-trash"></use></svg></button></div></div>';
          $($this).append(recRow);
...
(function () {
    $('.add-address-more').each(function() {
        var $this = $('.address-group',this);
        // var upload = $('.field1', this).length;
        var upload = $('.field1', this).length;
        // upload = a;
        $('.del-button', this).on('click', function(){
            var a = $('.field1', this).length;
        })
        $('.add-more-address a',this).on('click', function(e) {
          e.preventDefault();
          var recRow = '<div class="field1 js-field more-container"><div class="field1__label">Address</div><div class="field1__wrap"><input class="field1__input js-field-input" type="text" name="address'+ upload +'"><button class="del-button" onclick="delRow(this)" type="button"><svg class="icon icon-trash"><use xlink:href="img/sprite.svg#icon-trash"></use></svg></button></div></div>';
          $($this).append(recRow);
...
function delRow(el) {
    var element = el;
    element.closest('.more-container').remove();
    // console.log($(this))
    // $('.del-button',this).on('click', function() {
